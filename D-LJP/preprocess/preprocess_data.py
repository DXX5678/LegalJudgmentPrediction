...
def preprocess_data(data_path, data_size=None, shuffle=True):
    ...
    input_datas, target_articles, target_accusations = [], [], []
    r = '[’!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~\n。！，、（）“”]+'
    for line in all_lines:
        data = json.loads(line)
        res = {"accusation": [0 for i in range(200)], "articles": [0 for i in range(183)]}
        ...
        input_datas.append(fact)
        target_articles.append(res['articles'])
        target_accusations.append(res['accusation'])
    return input_datas, target_articles, target_accusations


def get_article_idx(article):
    article2idx = {'第347条': 0, '第264条': 1, '第383条': 2, '第234条': 3, '第133条': 4, '第196条': 5, '第280条': 6, '第345条': 7,
...
if __name__ == '__main__':
    # print(os.getcwd())
    input_datas, target_articles, target_accusations = preprocess_data(
        "E:\PyCharm\pythonProject\D-LJP\data\data_test.json", None, False)
    print(len(input_datas))
    print(len(target_articles))
    print(len(target_accusations))
